...
plot(subset$Timestamp, subset$Global_active_power, type = "l", col = "black", ylab = "Global Active Power", xlab = "")
plot(subset$Timestamp, subset$Voltage, type = "l", col = "black", xlab = "datetime", ylab = "Voltage")
...
plot(subset$Timestamp, subset$Global_reactive_power, type = "l", col = "black", ylab = "Global_reactive_power", xlab = "datetime")
dev.off()